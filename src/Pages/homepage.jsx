  ...
  return (
    <div className='w-screen h-max overflow-x-hidden'>
        ...
        <section id='home' className='relative z-[4444444] w-screen h-[64vh] md:h-[80vh] border-b-[10px] border-b-blue-300 bg-blue-700 overflow-hidden flex flex-col justify-center md:rounded-br-[200px]'>
            <img className='absolute z-[2222] w-[45%] right-0 bottom-[-100px] md:flex hidden' src={People2} alt="Seorang penjelajah" />
            ...
            <div className='md:flex hidden md:w-[500px] md:flex hidden md:h-[500px] right-0 rounded-full border border-slate-100 absolute'>
            </div>
        ...
        <section className='relative w-screen h-max px-6 md:px-12 pt-6 md:pt-12 pb-6'>
            ...
            <div className='relative w-full md:flex z-[33] justify-between bg-blue-600 h-max md:h-[600px] rounded-[16px] items-center border border-slate-300 mt-8'>
                <div className='relative w-full md:w-1/2 h-1/2 md:h-full text-white flex p-6 md:p-14 flex-col justify-between text-left md:overflow-visible overflow-hidden'>
                    ...
                    <div className='relative md:pl-12 md:border-l-[2px] h-max md:h-[30%] flex flex-col justify-end md:border-l-white'>
                        <h2 className='font-[600] text-[50px] md:text-[74px] flex items-center mb-2'>732,8 <span className='text-[50px] md:text-[74px] ml-4 relative'>Juta</span></h2>
                ...
                <div className='w-max flex justify-between items-center mt-12'>
                    {   
                        ...
                        Wisata?.map((data, index) => (
                            <div key={index} className='w-[300px] md:w-[340px] h-[400px] md:h-[440px] mr-6 bg-white overflow-hidden border border-slate-300 shadow-lg rounded-[20px]'>
                ...
                <div className='w-max flex items-center pb-3'>
                    {
                        ...
                        allContact && allContact?.length > 0 ? (
                            allContact?.map((data, index) => (
                                <div key={index} className='w-[90vw] md:w-[350px] flex z-[33] flex-col justify-between items-center mt-8 mr-3 md:mr-6'>
        ...
        <section className='relative w-screen h-max p-4 md:px-12 pt-12 pb-6'>
            ...
            <div className='relative w-full md:flex z-[33] justify-between md:pb-0 pb-4 bg-blue-600 h-max md:h-[600px] rounded-[16px] items-center mt-8'>
                <div className='relative md:absolute flex md:mt-0 mt-12 md:hidden right-0 w-full md:w-1/2 md:mb-0 mb-4 h-full flex items-center'>
                    <img src={RempahBg} alt="spice" className='md:scale-[1.1] relative top-10 md:bottom-1' />
                </div>
                <div className='relative w-full h-max md:h-full overflow-hidden text-white flex p-6 md:p-14 flex-col justify-between text-left'>
                    ...
                    <p className='w-max mt-6 md:mt-12 md:text-[16px] text-[12px] flex items-center bg-white rounded-full px-4 py-2 text-blue-600'><b className='mr-1 md:flex hidden'>Indonesia</b> penghasil rempah terbesar ke-4 dunia!</p>
                </div>
                <div className='relative md:absolute md:flex hidden right-0 w-full md:w-1/2 md:mb-0 mb-12 h-full flex items-center'>
        ...
        <div id='spice' className='relative w-screen h-max pt-12 md:pt-16 pl-4 md:pl-12 pb-8 md:pb-12'>
            <img src={Jawa} className='absolute scale-[1.6] top-0 right-0 opacity-[0.2]  z-[-1]' alt='Jawa' />
            <div className='rounded-full text-white mb-4 bg-blue-400 w-max py-3 px-6'>Nusa2 - Cita Rasa Rempah</div>
            <h2 className='font-bold hidden md:flex items-center text-[36px]'>🫚 <span className='relative top-1 ml-3'>Aneka Ragam Rempah</span></h2>
            <div className='w-full pr-6 pb-5 overflow-x-auto items-center'>
                <div className='w-max flex justify-between items-center mt-12'>
                    {
                        loading ? (
                        ...
                        Rempah?.map((data, index) => (
                            <div key={index} className='w-[300px] h-[400px] md:w-[340px] md:h-[440px] mr-6 bg-white overflow-hidden border border-slate-300 shadow-lg rounded-[20px]'>
                                <div className='relative w-full overflow-hidden h-[50%]'>
                                    <div className='absolute z-[9999] rounded-full top-4 right-4 bg-white text-blue-600 border border-white px-5 py-2 w-max h-max text-[14px] flex items-center justify-center'>
                                        <p>Rempah</p> 
                                    </div>
        ...
        <section className='relative w-screen h-max p-4 md:p-12 md:mt-0 mt-4'>
            ...
            <div className='w-full flex items-center justify-between'>
                ...
                <div className="relative w-full md:w-[45%] flex md:mr-5 items-center">
                    ...
                    {
                        activeMicSpice ? (
                            <div className='rounded-full w-[54px] h-[46px] z-[333] md:flex hidden items-center justify-center bg-red-500 text-white ml-4 border border-green-700 cursor-pointer active:scale-[0.94] hover:brightness-[90%]' onClick={() => {setActiveMicSpice(false), stopListeningSpice()}}><FaMicrophone /></div>
                        ):
                            <div className='rounded-full w-[54px] h-[46px] z-[333] md:flex hidden items-center justify-center bg-green-500 text-white ml-4 border border-green-700 cursor-pointer active:scale-[0.94] hover:brightness-[90%]' onClick={() => {setActiveMicSpice(true), startListeningSpice()}}><FaMicrophone /></div>
                    }
                </div>
            </div>
            {
        ...
        <section className='relative w-screen h-max px-4 md:px-12 pt-12 pb-6'>
            ...
            <div className='relative w-full md:flex z-[33] justify-between bg-blue-600 md:pb-0 pb-6 h-max md:h-[600px] rounded-[16px] items-center mt-8'>
                ...
                <div className='relative w-full h-max md:h-full overflow-hidden text-white flex p-4 md:p-14 flex-col justify-between text-left'>
                    ...
                    <p className='w-max mt-6 md:mt-12 flex items-center bg-white rounded-full md:text-[16px] text-[12px] px-4 py-2 text-blue-600'><b className='mr-1'>Rendang</b> adalah makanan terenak didunia!</p>
                </div>
                <div className='absolute right-0 w-1/2 h-full hidden md:flex items-center'>
        ...
        <div className='relative w-screen h-max p-6 md:p-12'>
            ...
            <div className='w-full flex items-center justify-between'>
                <h2 className='font-bold hidden md:flex items-center text-[36px]'>🗺️ <span className='relative top-1 ml-3'>Peta Kuliner Nusantara</span></h2>
                <div className="relative w-full md:w-[45%] flex md:mr-5 items-center">
                    <div className="absolute inset-y-0 rtl:inset-r-0 start-0 flex items-center ps-3 pointer-events-none">
                        <svg className="w-4 h-4 text-gray-500 dark:text-gray-400md:top-0 relative top-3 md:top-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                            <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z"/>
                    ...
                    {
                        activeMicCulinary ? (
                            <div className='rounded-full w-[54px] h-[46px] z-[333] md:flex hidden items-center justify-center bg-red-500 text-white ml-4 border border-green-700 cursor-pointer active:scale-[0.94] hover:brightness-[90%]' onClick={() => {setActiveMicCulinary(false), stopListeningCulinary()}}><FaMicrophone /></div>
                        ):
                            <div className='rounded-full w-[54px] h-[46px] z-[333] md:flex hidden items-center justify-center bg-green-500 text-white ml-4 border border-green-700 cursor-pointer active:scale-[0.94] hover:brightness-[90%]' onClick={() => {setActiveMicCulinary(true), startListeningCulinary()}}><FaMicrophone /></div>
                    }
                </div>
            </div>
            {
