...
const Articles = () => {
  ...
  return (
    <div id='article' className={`relative w-screen h-max ${location.pathname.includes('/detail-main-article') ? 'px-4 lg:px-12 pb-12 pt-0' : 'p-4 lg:p-12'}`}>
                    ...
                    articles?.map((data, index) => (
                        <div key={index} className='w-full min-h-[180px] my-3 border border-blue-600 border-dashed rounded-[12px] bg-white shadow-lg p-5'>
                            <div className='w-full h-[50%] flex items-center justify-between overflow-hidden text-left rounded-[8px]'>
                                ...
                                <div className='rounded-[10px] text-[12px] w-max h-max px-4 py-2 hidden lg:flex items-center justify-center bg-green-600 text-white mr-4'>
                                    <p>Public</p>
                                </div>
                            </div>
                            <div className='w-full flex flex-wrap mt-3 items-center'>
                                <div className='rounded-full lg:mb-0 mb-3 w-max h-max px-4 py-2 flex items-center justify-center bg-slate-200 text-slate-500 mr-3'>
                                    <FaCalendarAlt className='mr-2' />  {data?.year}
                                </div>
                                <div className='rounded-full lg:mb-0 mb-3 max-w-[56%] h-max px-4 py-2 flex items-center justify-center bg-blue-200 text-blue-600 mr-4'>
                            ...
                            <hr className='mt-4' />
                            <p className='text-slate-500 mt-4 text-[14px] lg:text-[16px]'>
                                {data?.description}
                            </p>
