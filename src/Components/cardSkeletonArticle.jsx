...
const CardSkeletonArticle = () => {
  return (
    <section className='w-screen px-4 lg:px-12 mx-auto flex flex-col mt-8 pb-4'>
        <div className='w-full h-[240px] mt-10 border border-blue-600 border-dashed rounded-[12px] bg-white shadow-lg p-5'>
            <div className='w-full h-[50%] flex items-center justify-between overflow-hidden text-left rounded-[8px]'>
                ...
                <div className='rounded-full text-[12px] w-max h-max px-12 py-4 hidden relative bottom-5 lg:flex items-center justify-center bg-slate-300 animate-pulse mr-4'>
                </div>
            </div>
            <div className='w-full flex flex-wrap mt-0 items-center'>
                <div className='rounded-full lg:mb-0 mb-3 w-max h-[36px] px-12 flex items-center justify-center bg-slate-300 text-slate-500 mr-3'>
                </div>
                <div className='rounded-full lg:mb-0 mb-3 max-w-[56%] h-[36px] px-12 flex items-center justify-center bg-slate-300 text-blue-600 mr-4'>
